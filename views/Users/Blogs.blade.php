            ...
            <div class="row">
                <div class="col-md-8 col-lg-9 p-b-80">
                    <div class="p-r-45 p-r-0-lg">
                        <!-- item blog -->
                        <div class="p-b-63">
                            <a href="{{url('/user/blog-detail1')}}" class="hov-img0 how-pos5-parent">
                                <img src="{{asset('assets/img/images/blog-04.jpg')}}" alt="IMG-BLOG">
                            ...
                            <div class="p-t-32">
                                <h4 class="p-b-15">
                                    <a href="{{url('/user/blog-detail1')}}" class="ltext-108 cl2 hov-cl1 trans-04">
                                ...
                                <div class="flex-w flex-sb-m p-t-18">
                                    ...
                                    <a href="{{url('/user/blog-detail1')}}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
                                        Continue Reading
                        ...
                        <!-- item blog -->
                        <div class="p-b-63">
                            <a href="{{url('/user/blog-detail2')}}" class="hov-img0 how-pos5-parent">
                                <img src="{{asset('assets/img/images/blog-05.jpg')}}" alt="IMG-BLOG">
                            ...
                            <div class="p-t-32">
                                <h4 class="p-b-15">
                                    <a href="{{url('/user/blog-detail2')}}" class="ltext-108 cl2 hov-cl1 trans-04">
                                ...
                                <div class="flex-w flex-sb-m p-t-18">
                                    ...
                                    <a href="{{url('/user/blog-detail2')}}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
                                        Continue Reading
                        ...
                        <!-- item blog -->
                        <div class="p-b-63">
                            <a href="{{url('/user/blog-detail3')}}" class="hov-img0 how-pos5-parent">
                            ...
                            <div class="p-t-32">
                                <h4 class="p-b-15">
                                    <a href="{{url('/user/blog-detail3')}}" class="ltext-108 cl2 hov-cl1 trans-04">
                                ...
                                <div class="flex-w flex-sb-m p-t-18">
                                    ...
                                    <a href="{{url('/user/blog-detail3')}}" class="stext-101 cl2 hov-cl1 trans-04 m-tb-10">
                                        Continue Reading
