...
<section claas="sec2 ">
    ...
    <!-- Product -->
 <div class="col-md-12">
            <h1 class="h text-center mb-5">{All Products}</h1>
        </div>
                 ...
                 <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item">
                    ...
                    <div class="block2">
                        <div class="block2-pic hov-img0">
                            <img src="{{Storage::url($ls->image)}}" alt="IMG-PRODUCT">

                            <a href="/user/product-detail/{{$ls->id}}" class="block2-btn flex-c-m stext-104 cl2 size-102 bg0 bor2 hov-btn1 p-lr-15 trans-04 js-name">
                                Quick View
                            </a>
                        </div>
                        ...
                        <div class="block2-txt flex-w flex-t p-t-14">
                            <div class="block2-txt-child1 flex-col-l ">
                                <a href="/user/product-detail/{{$ls->id}}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                      {{$ls->title}}
                                </a>
                            ...
                            <div class="block2-txt-child2 flex-r p-t-3">
                                <a href="#" class="btn-addwish-b2 dis-block pos-relative js-addwish-b2 mt-3">
